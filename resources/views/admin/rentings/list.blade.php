                ...
                <tbody>
                    @foreach ($rents as $rent)
                        <tr>
                            ...
                            <td>{{ $rent->status }}</td>
                            <td>
                                <a href="{{ url('admin/rentings/edit/' . $rent->id) }}">
                            ...
                            <td>
                                <a href="">
                                    <form method="POST" onsubmit="window.confirm('Are you sure you want to delete the rent?')" action="{{ route('rent.destroy', $rent->id) }}">
                                        @csrf
                                        @method('DELETE')
